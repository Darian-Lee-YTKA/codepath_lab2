...
class ViewController: UIViewController,
  ...
  @IBAction func didTapMushroom(_ sender: UITapGestureRecognizer) {
    animateMushroom()
          ...
          if let powerup = powerup { // we can use == or != to check if something is nil or not
              print("Got a powerup!")
              ...
              print("Didn't get a powerup")
               ...
               // `powerup` is now of type `MushroomPowerup`. `powerup` is only accessible from inside the if-let curly brace
